...
@Configuration
public class DefaultExceptionConfiguration{

	protected Logger logger;

	public DefaultExceptionConfiguration() {
	 ...
	 */
	@Bean(name = "globalSimpleMappingExceptionResolver")
	public SimpleMappingExceptionResolver createSimpleMappingExceptionResolver() {
		logger.info("Creating globalSimpleMappingExceptionResolver");
...
//		mappings.setProperty("DatabaseException", "databaseError");
		...
		r.setWarnLogCategory("com.beanframework.ExceptionLogger"); // No default
